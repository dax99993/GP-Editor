...
class InputRangeSliderWidget extends StatefulWidget {
  const InputRangeSliderWidget({
    super.key,
    required this.value,
    required this.min,
    required this.max,
  ...
  @override
  State<InputRangeSliderWidget> createState() => _InputRangeSliderWidgetState();
}

class _InputRangeSliderWidgetState extends State<InputRangeSliderWidget> {
  late double _sliderValue;
  RangeValues _currentRange = RangeValues(2, 4);
